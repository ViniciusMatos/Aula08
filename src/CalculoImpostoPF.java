...
public class CalculoImpostoPF {
	...
	private static void imprimirResultado() {
		...
		System.out.println("**");
		System.out.println("**	   FUNCIONÁRIO: Antonio Coutinho");
		System.out.println("******************************************************************");
		System.out.println("******************************************************************");
		System.out.println("**");
		...
		System.out.println("**	IMPOSTO RETIDO: 1.123,84 BRL");
		System.out.println("**	   SALÁRIO LÍQ: 6.876,16 BRL");
		System.out.println("**");
		System.out.println("******************************************************************");
		System.out.println("******************************************************************");
		System.out.println("**");
		...
		System.out.println("**");
		System.out.println("**	 	  ALIQUOTA: 11 %");
		System.out.println("**	IMPOSTO RETIDO: 880,00 BRL");
		System.out.println("**");
		System.out.println("******************************************************************");
		System.out.println("******************************************************************");
		System.out.println("**");
		System.out.println("**   SALÁRIO LIQUIDO: 5.996,16 BRL");
		System.out.println("**");
		System.out.println("******************************************************************");
		System.out.println("******************************************************************");
	}
